...
namespace AudioStock
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            AudioStockContext _context = new AudioStockContext();
            if (_context.Usuarios.Count() == 0)
            {
                Usuario usuarioinical = new Usuario();
                usuarioinical.NombreUsuario = "Eduardo";
                usuarioinical.Password = "Mass";
                _context.Usuarios.Add(usuarioinical);
